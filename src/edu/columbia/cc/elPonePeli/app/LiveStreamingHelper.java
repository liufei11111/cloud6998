...
public class LiveStreamingHelper {
    ...
    private final String streamingStackName = "elPonePeliStreamingtest";
    ...
    public void createFormation(String stackName, String logicalResourceName) {
        ...
        try {
            ...
            Parameter pInstanceType = new Parameter().withParameterKey(
                    "InstanceType").withParameterValue("t2.micro");
            params.add(pInstanceType);
            Parameter pKeyPair = new Parameter().withParameterKey("KeyPair")
                    .withParameterValue("fbtest");
            params.add(pKeyPair);
            Parameter pLicKey = new Parameter().withParameterKey(
                    "WowzaLicenseKey").withParameterValue(
                    "SVRT3-HEKkZ-zRp6C-xPTA7-b4a8P-VwR9R-7U6W7f6TXXxt");
            params.add(pLicKey);

            CreateStackRequest createRequest = new CreateStackRequest()
                    .withTemplateURL(streamingTemplateURL)
                    .withStackName(streamingStackName).withParameters(params);
            System.out.println("Creating a stack called "
